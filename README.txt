...
- Reports includes Daily, Weekly, and Monthly tabs for summarized damage quantities and material usage.
- Daily reports use a selected date; Weekly reports use an ISO week; Monthly reports use a selected month.
- Report columns: Date / Period, Damage, Total QTY, Material Used, and Total Material Used QTY.
- Reports can be printed in A4 landscape and exported to a formatted XLSX workbook.
